...
impl Instruction {
    ...
    fn decode<R: Read>(bytes: &mut Bytes<R>) -> Option<Self> {
        ...
        match next_byte(bytes)? {
            ...
            0x90 => root!(Sub, destination: RegisterImplied(B)),
            0x91 => root!(Sub, destination: RegisterImplied(C)),
            0x92 => root!(Sub, destination: RegisterImplied(D)),
            0x93 => root!(Sub, destination: RegisterImplied(E)),
            0x94 => root!(Sub, destination: RegisterImplied(H)),
            0x95 => root!(Sub, destination: RegisterImplied(L)),
            0x96 => root!(Sub, destination: MemoryIndirect(HL)),
            0x97 => root!(Sub, destination: RegisterImplied(A)),
            ...
            0xA0 => root!(And, destination: RegisterImplied(B)),
            0xA1 => root!(And, destination: RegisterImplied(C)),
            0xA2 => root!(And, destination: RegisterImplied(D)),
            0xA3 => root!(And, destination: RegisterImplied(E)),
            0xA4 => root!(And, destination: RegisterImplied(H)),
            0xA5 => root!(And, destination: RegisterImplied(L)),
            0xA6 => root!(And, destination: MemoryIndirect(HL)),
            0xA7 => root!(And, destination: RegisterImplied(A)),
            0xA8 => root!(Xor, destination: RegisterImplied(B)),
            0xA9 => root!(Xor, destination: RegisterImplied(C)),
            0xAA => root!(Xor, destination: RegisterImplied(D)),
            0xAB => root!(Xor, destination: RegisterImplied(E)),
            0xAC => root!(Xor, destination: RegisterImplied(H)),
            0xAD => root!(Xor, destination: RegisterImplied(L)),
            0xAE => root!(Xor, destination: MemoryIndirect(HL)),
            0xAF => root!(Xor, destination: RegisterImplied(A)),
            0xB0 => root!(Or, destination: RegisterImplied(B)),
            0xB1 => root!(Or, destination: RegisterImplied(C)),
            0xB2 => root!(Or, destination: RegisterImplied(D)),
            0xB3 => root!(Or, destination: RegisterImplied(E)),
            0xB4 => root!(Or, destination: RegisterImplied(H)),
            0xB5 => root!(Or, destination: RegisterImplied(L)),
            0xB6 => root!(Or, destination: MemoryIndirect(HL)),
            0xB7 => root!(Or, destination: RegisterImplied(A)),
            0xB8 => root!(Cp, destination: RegisterImplied(B)),
            0xB9 => root!(Cp, destination: RegisterImplied(C)),
            0xBA => root!(Cp, destination: RegisterImplied(D)),
            0xBB => root!(Cp, destination: RegisterImplied(E)),
            0xBC => root!(Cp, destination: RegisterImplied(H)),
            0xBD => root!(Cp, destination: RegisterImplied(L)),
            0xBE => root!(Cp, destination: MemoryIndirect(HL)),
            0xBF => root!(Cp, destination: RegisterImplied(A)),
